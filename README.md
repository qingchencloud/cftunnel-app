...
- **二维码与 Telegram 分享** — 生成地址后可直接展示二维码、复制或分享到 Telegram
- **常用场景模板** — 前端预览、Web 应用、Webhook、Home Assistant 一键填入端口
- **最近使用** — 自动记住最近使用的本地端口，下次打开直接选择
...
生成地址后，还可以展示二维码、分享到 Telegram；首页会记住最近使用的端口，并提供前端预览、Web 应用、Webhook、Home Assistant 场景模板。
